...
//[OK]
//Löscht einen User aus Redis (wird deaktiviert).
//--> Inkrement der user_id wird nicht gelöscht!! Nach vollständigem löschen wird trotzdem ab letzter uID weitergezählt.
router.delete( '/user/:user_id', jsonParser, function(req, res) {
    ...
    db.get('user:'+req.params.user_id, function(err, rep) {
        ...
        if (rep) {
            ...
            //User wird nicht direkt aus Redis gelöscht sondern sein Status wird auf false gesetzt, womit er sich nicht mehr einloggen kann.
            user.active = false;
